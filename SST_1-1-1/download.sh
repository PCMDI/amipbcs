...
set oi2path=/work/durack1/Shared/150219_AMIPForcingData/SST_1-1-1/ ; ## UPDATE : PATH REQUIRES UPDATING ##
######
...
# e.g 3,14 (April 2015 through March 2016), 5,15 (June 2015 through April 2016), 16,20 (May 2016 through September 2016) ; ##
###### UPDATE : YEARS REQUIRE UPDATING ##
ncks -O -h -d time,16,20 MODEL.OI2.ice.mnly.201501-201609.unf.nc ICE.update.nc ; # Extract June 2015 to March 2016 ## UPDATE : YEARS IN FILENAMES REQUIRE UPDATING ##
ncks -O -h -d time,16,20 MODEL.OI2.sst.mnly.201501-201609.unf.nc SST.update.nc ; ## UPDATE : YEARS IN FILENAMES REQUIRE UPDATING ##
...
ncdump -v date ../SST_NEW5/MODEL.SST.HAD187001-198110.OI198111-201604.nc
...
ncrcat ../SST_NEW5/MODEL.ICE.HAD187001-198110.OI198111-201604.nc ICE.update.nc MODEL.ICE.HAD187001-198110.OI198111-201609.nc ; ## UPDATE : YEARS IN FILENAMES REQUIRE UPDATING ##
ncrcat ../SST_NEW5/MODEL.SST.HAD187001-198110.OI198111-201604.nc SST.update.nc MODEL.SST.HAD187001-198110.OI198111-201609.nc ; ## UPDATE : YEARS IN FILENAMES REQUIRE UPDATING ##
...
ncdump -v date MODEL.SST.HAD187001-198110.OI198111-201609.nc ; ## UPDATE : YEARS IN FILENAMES REQUIRE UPDATING ##
# Purge partial new files
rm -f ICE.update.nc ; # These may not purge do to a file handle being unreleased by ncrcat
rm -f MODEL.OI2.ice.mnly.201501-201609.unf.nc ; ## UPDATE : YEARS IN FILENAMES REQUIRE UPDATING ##
rm -f SST.update.nc
rm -f MODEL.OI2.sst.mnly.201501-201609.unf.nc ; ## UPDATE : YEARS IN FILENAMES REQUIRE UPDATING ##
######
