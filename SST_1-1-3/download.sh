...
### USER TO SET ###
setenv NCARG_ROOT /export/durack1/anaconda2/envs/cdat212cmor327nclnco
setenv PATH /export/durack1/anaconda2/envs/cdat212cmor327nclnco/bin:${PATH} ; # Add wrapit77, ncl, nco to PATH

###### UPDATE : PATH REQUIRES UPDATING ##
set oi2path=/work/durack1/Shared/150219_AMIPForcingData/SST_1-1-3/ ; ## UPDATE : PATH REQUIRES UPDATING ##
set oi2oldpath=/work/durack1/Shared/150219_AMIPForcingData/SST_1-1-2/ ; ## UPDATE : PATH REQUIRES UPDATING ##
######
...
ncks -O -h -d time,15,20 MODEL.OI2.ice.mnly.201601-201709.unf.nc ICE.update.nc ; # Extract months ## UPDATE : YEARS IN FILENAMES REQUIRE UPDATING ##
ncks -O -h -d time,15,20 MODEL.OI2.sst.mnly.201601-201709.unf.nc SST.update.nc ; ## UPDATE : YEARS IN FILENAMES REQUIRE UPDATING ##
...
ncdump -v date ${oi2oldpath}MODEL.SST.HAD187001-198110.OI198111-201703.nc
...
ncrcat ${oi2oldpath}MODEL.ICE.HAD187001-198110.OI198111-201703.nc ICE.update.nc MODEL.ICE.HAD187001-198110.OI198111-201709.nc ; ## UPDATE : YEARS IN FILENAMES REQUIRE UPDATING ##
ncrcat ${oi2oldpath}MODEL.SST.HAD187001-198110.OI198111-201703.nc SST.update.nc MODEL.SST.HAD187001-198110.OI198111-201709.nc ; ## UPDATE : YEARS IN FILENAMES REQUIRE UPDATING ##
...
ncdump -v date MODEL.SST.HAD187001-198110.OI198111-201709.nc ; ## UPDATE : YEARS IN FILENAMES REQUIRE UPDATING ##
# Purge partial new files
rm -f ICE.update.nc ; # These may not purge do to a file handle being unreleased by ncrcat
rm -f MODEL.OI2.ice.mnly.201601-201709.unf.nc ; ## UPDATE : YEARS IN FILENAMES REQUIRE UPDATING ##
rm -f SST.update.nc
rm -f MODEL.OI2.sst.mnly.201601-201709.unf.nc ; ## UPDATE : YEARS IN FILENAMES REQUIRE UPDATING ##
######
