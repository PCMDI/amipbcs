...
PJD 20 Aug 2025 - Updated for new CMIP7Plus data
...
dataVers = {
    "PCMDI-AMIP-ERSST5-1-0": {
        "ver": "v20250820",
        "verId": "ERSST5-1-0",
        "verPath": "input4MIPs/CMIP7Plus/CMIP/PCMDI/PCMDI-AMIP-ERSST5-1-0/",
    },
    "PCMDI-AMIP-Had1p1-1-0": {
        "ver": "v20250820",
        "verId": "Had1p1-1-0",
        "verPath": "input4MIPs/CMIP7Plus/CMIP/PCMDI/PCMDI-AMIP-Had1p1-1-0/",
    },
    "PCMDI-AMIP-OI2p1-1-0": {
        "ver": "v20250820",
        "verId": "OI2p1-1-0",
        "verPath": "input4MIPs/CMIP7Plus/CMIP/PCMDI/PCMDI-AMIP-OI2p1-1-0/",
    },
}

# Old data
verOldId = "v1.1.10"
verOld = "v20250815"  # "v20250807"  # Update for each run
# verOldPath = "/global/cfs/projectdirs/m4931/gsharing/user_pub_work"
verOldPath = "."
verOldPath = os.path.join(verOldPath, "input4MIPs/CMIP7/CMIP/PCMDI/PCMDI-AMIP-1-1-10/")
...
# loop across input data
for data in dataVers.items():
    print(data[0])
    dataDic = data[1]
    ver = dataDic["ver"]
    verId = dataDic["verId"]
    verPath = dataDic["verPath"]
    print(ver, verId, verPath)
    ...
    for var in ["tos", "tosbcs"]:
        for yr in np.arange(1870, ds5.time.data[-1].year + 1):  # 1870
